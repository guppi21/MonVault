...
const CONTRACT_ADDRESS = "PASTE_YOUR_REAL_CONTRACT_ADDRESS";
...
export default function Home() {
  ...
  async function uploadToIPFS() {
    ...
    // THIS IS NORMAL
    // metadata.json gets uploaded too
    ...
    try {
      ...
      for (let i = 1; i <= Number(total); i++) {
        ...
        try {
          ...
          console.log("NFT ERROR:", err);

        }
      }

      console.log("LOADED CAPSULES:", items);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Secure memories for your future self.
        </p>
