...
export default function Home() {
  ...
  async function uploadToIPFS() {
    ...
    const metadataUpload = await axios.post(
      ...
      {
        headers: {
          Authorization: `Bearer ${process.env.eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..QW5G3D-LgsGn6KDqFpprFYWW8yboZFcz9MOjUvGN2Uk}`,
        },
      }
    );
